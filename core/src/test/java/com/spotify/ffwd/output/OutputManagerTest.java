...
public class OutputManagerTest {
  ...
  public void testTagsToResource() {
    ...
    assertEquals(
        new Metric(m1.getKey(), m1.getValue(), m1.getTime(),
  ...
  public void testTagsToResourceForBatches() {
    ...
    final Batch.Point point =
        new Batch.Point(m1.getKey(), m2Tags, m1.getResource(), m1.getValue(), m1.getTime());
    final Batch batch =
        new Batch(Maps.newHashMap(), Maps.newHashMap(), Collections.singletonList(point));
  ...
  public void testBatchNullKeyNotDropping() {
    ...
    final Batch.Point point =
        new Batch.Point(null, m2Tags, m1.getResource(), m1.getValue(), m1.getTime());
    final Batch batch =
        new Batch(Maps.newHashMap(), Maps.newHashMap(), Collections.singletonList(point));
