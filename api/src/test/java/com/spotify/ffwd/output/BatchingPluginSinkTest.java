...
public class BatchingPluginSinkTest {
  ...
  public void setup() {
    ...
    metric = new Metric("KEY", value, System.currentTimeMillis(), Map.of("tag", "value"),
        ImmutableMap.of());
  }
  ...
  public BatchingPluginSink createBatchingPluginSink() {
    ...
    modules.add(new AbstractModule() {
      ...
      protected void configure() {
        ...
        bind(Long.class).annotatedWith(Names.named("highFrequencyDataRecycleMS"))
            .toInstance(highFrequencyDataRecycleMS);
        bind(Integer.class).annotatedWith(Names.named("minNumberOfTriggers"))
